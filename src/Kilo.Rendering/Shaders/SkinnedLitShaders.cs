...
public static class SkinnedLitShaders
{
    public const string WGSL = """
        ...
        fn vs_main(
            ...
            let skinned_tangent = normalize((skin_matrix * vec4<f32>(tangent.xyz, 0.0)).xyz);
            let t = normalize((object.model * vec4<f32>(skinned_tangent, 0.0)).xyz);
        ...
        // ---- Fragment shader (identical PBR to BasicLit) ----
